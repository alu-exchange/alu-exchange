...
| Repo | CI Status | Description | Tech Stack |
|------|-----------|-------------|------------|
| 🖥️ [alu-frontend](https://github.com/alu-exchange/alu-frontend) | ![CI](https://github.com/alu-exchange/alu-frontend/actions/workflows/alu-ci.yml/badge.svg?branch=main) | Public-facing frontend for web & mobile users. Signup, login, trading UI, dashboards, portfolio, market charts. | React, Redux, TailwindCSS, Node.js |
| ⚙️ [alu-backend](https://github.com/alu-exchange/alu-backend) | ![CI](https://github.com/alu-exchange/alu-backend/actions/workflows/alu-ci.yml/badge.svg?branch=main) | Backend APIs & services. Auth, user accounts, transactions, wallet interactions. | Node.js, Express, PostgreSQL |
...
- Branch Protection: ✅ Production branches protected  
- CI/CD: ✅ Automated builds and tests for all services  
- DevOps: ✅ Scripts for deployment, environment security, and monitoring  
- Secrets Management: ✅ Secure API & wallet keys in GitHub Environments  
- Team Roles: ✅ Owner, DevOps, Frontend, Backend, Core/Trading teams  

---

## 🔗 Quick Links

- [Documentation](https://github.com/alu-exchange/alu-docs)  
- [Alu Exchange Website (Live)](#)  
- [Project Board & Tasks](#)
